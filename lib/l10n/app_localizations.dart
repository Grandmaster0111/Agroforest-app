...
abstract class AppLocalizations {
  ...
  ///
  /// In en, this message translates to:
  /// **'Select a crop to see irrigation advice'**
  String get selectCrop;

  /// No description provided for @soilDry.
  ///
  /// In en, this message translates to:
  /// **'Soil is dry for {cropName} – irrigation required'**
  String soilDry(Object cropName);

  /// No description provided for @soilWet.
  ///
  /// In en, this message translates to:
  /// **'Soil is wet for {cropName} – no irrigation needed'**
